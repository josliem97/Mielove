...
NEW_CONFIG = {
    ...
    "components": [
        ...
        # --- BANK ---
        {
            "id": "bank_block",
            "type": "element_bank",
            "x": 37, "y": 8200, "w": 500, "h": 800, "z": 2,
            "props": { "name": "Anh Quân & Thảo Trang", "account": "1234567890", "bank": "Vietcombank", "qr": "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=VCB-1234567890" }
        },
...
def seed():
    ...
    conn.commit()
    conn.close()
    print("Successfully applied Perfection Layer!")
